...
export default function Home() {
  ...
  return (
    <div className="flex h-[100vh] bg-gradient-to-br from-[#0f0026] via-[#1a003c] to-[#2d006b]">
      <div className="w-[80vw] flex flex-col justify-center items-center  p-4 pb-0">
        ...
        <div className="h-fit min-h-[500px]">
          <ArrayVisualizer elements={array.map((el, index) => ({ el: el.value ?? el, index, id: el.id }))} onDelete={removeElement} />
        </div>
        <Instructions />
      </div>
      <motion.div
        ...
        className="w-[20vw] bg-white/10 backdrop-blur-lg border-l border-white/20 overflow-y-auto"
      >
        <Sidebar />
      </motion.div>
    </div>
